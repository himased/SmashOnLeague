...
{
    [SerializeField] string[] tagsToCheck; //The tag to check, example; Enemy, Environment, Default, etc.
    [SerializeField] int flickerAmount = 5; //The times it will flicker
    [SerializeField] float movementSpeed = 0.5f; //Affected unit movement speed towards wisp
    [SerializeField] float rotationSpeed = 5; //Affected unit rotation speed towards wisp
    [SerializeField] float radius = 10; //Area of effect, can be visualize using gizmos
    [SerializeField] float stopRange = 1.5f; //How close to the wisp the affected unity will stop
    [SerializeField] float flickerDuration = 2; //Duration of wisp flicker
    [SerializeField] float flickerRestDuration = 3; //Duration between flickers
    [SerializeField] float idleFloatDistance = 0.5f; //Floating; Y distance for the wisp to move up and down
