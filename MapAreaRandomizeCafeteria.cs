...
public class MapAreaRandomizeCafeteria : MonoBehaviour
{
    public static MapAreaRandomizeCafeteria Instance;
    public GameObject mapArea1, mapArea2, mapArea3, mapArea4;
    int randNum1, randNum2;

    public bool isFloor1R, isFloor2F, isFloor2R, isFloor2L;
